...
export class Browser {
	...
	public constructor(startingURL: URL, browserType: BrowserType = 'firefox', vpn: boolean = false) {
		...
		this.driver = new Builder().forBrowser(browserType).setChromeOptions(chromeOptions).build();
